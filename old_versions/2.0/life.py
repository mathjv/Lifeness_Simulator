# Life | Lifeness Simulator | Lifeness Project | MJ
...
class SettingsDialog(QDialog):
    def __init__(self, parent=None, current_lang="es"):
        ...
        self.cmb_lang = QComboBox(); self.cmb_lang.addItems(["Español", "English"]); self.cmb_lang.setCurrentText(current_lang)
...
class ReportGenerator:
    def __init__(self, meta: MetaProyecto, enfermedades: List[Enfermedad]):
        ...
        self.out_path = os.path.join(self.output_dir, f"Life Report {datetime}.docx")
...
class MainWindow(QMainWindow):
    def __init__(self, parser, meta: MetaProyecto):
        ...
        self.btn_report = QPushButton("Guardar Reporte")
        ...
        self.txt_oms.setHtml("<b>OMS | Recursos y referencias</b><p>Aplicacion evaluada profesionalmente, para más informacion registre el producto.</p>")
    ...
    def show_info(self):
        ...
        dlg.setWindowTitle("Life | Credits")
        info = (
