...
class DocxParser:
    ...
    def _generate_demo(self, min_cases=20):
        ...
        while len(self.enfermedades) < min_cases:
            ...
            idx += 1
        logger.info("Completed MAX: %d", len(self.enfermedades))
...
class GLHumanWidget(QOpenGLWidget):
    def __init__(self, parent=None):
        ...
        self.frame_delay = 0.1  # 100 ms entre frames (puedes leerlo del gif también)
    ...
    def initializeGL(self):
        ...
        self.load_gif("assets/backgrounds/bg.gif")
    ...
    def paintGL(self):
    # NO usamos glClearColor aquí, el GIF será el fondo
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parser: DocxParser):
        super().__init__()
        self.setWindowTitle("Lifeness Simulator | Life")
        self.setWindowIcon(QIcon("assets/icons/life_ico (1)"))
        self.parser = parser
    ...
    def confirm_exit(self):
        ...
        if resp == QMessageBox.Yes:
            ...
            logger.info("Success.")
            logger.info("Gracias Por Usar Lifeness Simulator. Version 1.02 - Nuevas Actualizaciones a Futuro")
